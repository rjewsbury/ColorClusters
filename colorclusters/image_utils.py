...
def map_to_paletted_image(img, colors, distance=euclidean, output_queue=None):
    """
    ...
    index_data = map_pixels_to_closest_color_index(list(img.getdata()), colors, distance=distance, output_queue=output_queue)
